...
//ROBOT ARM LENGTH
#define LOW_SHANK_LENGTH 183.4
#define HIGH_SHANK_LENGTH 173.417
...
#define X_HOME_STEPS 2300//1020 //765 //860 // STEPS FROM X_ENDSTOP TO INITIAL_XYZ FOR UPPER ARM
#define Y_HOME_STEPS 1600//1900 //1940 // STEPS FROM Y_ENDSTOP TO INITIAL_XYZ FOR LOWER ARM // 
#define Z_HOME_STEPS 9600//3640 // STEPS FROM Z_ENDSTOP TO INITIAL_XYZ FOR ROTATION CENTER // 19200 for a full revolution 
...
#define HOME_DWELL 350 // INCREASE TO SLOW DOWN HOMING SPEED
#define HOME_DWELL_Z 200 // INCREASE TO SLOW DOWN HOMING SPEED
